...
const ASSIGNMENT_ROWS = [
  {
    ...
    packageVersionId: "40000000-0000-4000-8000-000000000004",
    assigneeType: "user",
    assigneeId: "70000000-0000-4000-8000-000000000001",
    status: "requested",
    approverUserId: null,
    approvedAt: null,
  },
  {
    ...
    packageVersionId: "40000000-0000-4000-8000-000000000001",
    assigneeType: "user",
    assigneeId: "70000000-0000-4000-8000-000000000002",
    status: "approved",
    approverUserId: FIXTURE_APPROVER_ID,
    approvedAt: "2026-08-11T14:05:00Z",
  },
  {
    id: "50000000-0000-4000-8000-000000000003",
    packageVersionId: "40000000-0000-4000-8000-000000000002",
    assigneeType: "org_node",
    assigneeId: "90000000-0000-4000-8000-000000000001",
    status: "active",
    approverUserId: FIXTURE_APPROVER_ID,
  ...
  },
  {
    ...
    packageVersionId: "40000000-0000-4000-8000-000000000006",
    assigneeType: "agent",
    assigneeId: "80000000-0000-4000-8000-000000000001",
    status: "revoked",
    approverUserId: FIXTURE_APPROVER_ID,
    approvedAt: "2026-07-28T16:20:00Z",
  },
];
...
console.log(
  `Seeding ${packageVersionFixtures.length} work package versions (real, from @arm/catalog)...`,
);
for (const v of packageVersionFixtures) {
  await db
    .insert(workPackageVersionTable)
    .values({
      id: v.id,
      tenantId: TENANT_ID,
