...
> This doc answers: *what job types and functions exist inside an automated OEM?*
> `oem-work-package-design.md` answers: *what does each one do daily, and what should its ARM work package contain?*
> `token-cost-optimization.md` answers: *where does the token money go, and how do we save it?*
