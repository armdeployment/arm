...
Report abusive, harassing, or otherwise unacceptable behaviour privately
through
[GitHub's private vulnerability reporting](https://github.com/armdeployment/arm/security/advisories/new)
— the same private channel used for security issues, so reports do not have to
be made in public. All complaints will be reviewed and investigated promptly
and fairly.
