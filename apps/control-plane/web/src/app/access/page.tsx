                ...
                {data.requests.map((req) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5">
                      <code
                        className="rounded-md bg-[var(--bg-elevated)] px-2 py-0.5 text-xs font-medium"
                        style={{ color: "var(--text-secondary)" }}
                      >
                        {req.action}
                      </code>
                    ...
                    <td className="px-5 py-3.5">
                      <span
                        className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold ${STATUS_STYLES[req.status] ?? ""}`}
                      >
                        {req.status}
                      </span>
                    </td>
