...
const ALERTS = [
  {
    ...
    severity: "warning",
    scope: "Manufacturing",
    message: "Budget at 76% — Assembly Line A close to monthly cap",
    time: "2 hours ago",
  },
  {
    id: "a2",
    ...
    severity: "info",
    scope: "Engineering",
    message: "ux-optimizer auto-downgraded to GLM-5.2 (background tier)",
    time: "5 hours ago",
  },
  {
    id: "a3",
    ...
    severity: "critical",
    scope: "Operations",
    message: "Incident Response team exceeded 90% budget — drawing from reserve",
    time: "1 day ago",
  },
  {
    id: "a4",
    ...
    severity: "warning",
    scope: "All",
    message: "Reconciliation drift 2.0% — provider bill vs proxy metering within tolerance",
    time: "2 days ago",
  },
];
