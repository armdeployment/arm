  ...
  return (
    ...
    >
      ...
      <div className="border-t px-4 py-3" style={{ borderColor: "var(--border)" }}>
        <div className="text-xs font-medium" style={{ color: "var(--text-muted)" }}>Blocked Models</div>
      ...
      {/* Available models */}
      <div className="border-t px-4 py-3" style={{ borderColor: "var(--border)" }}>
        <div className="text-xs font-medium" style={{ color: "var(--text-muted)" }}>Available for All Clearances</div>
        <div className="mt-2 flex flex-wrap gap-2">
