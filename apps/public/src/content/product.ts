...
export const deliverables = [
  {
    ...
    scope:
      "Desktop GUI is explicitly out of scope (A7) — the surface is the web questionnaire plus signed platform installers wrapping the CLI.",
  },
  {
    id: "artifactory",
    ...
    scope:
      "Cross-tenant artifact sharing, paid/licensed components, and semantic search are explicitly out of scope for this phase.",
  },
  {
    id: "adoption",
    ...
    scope:
      "Realtime is scoped to the two panels that need it (funnel, recent activations); everything else is server-rendered with revalidation, not a general-purpose live feed.",
  },
];
