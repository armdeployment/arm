...
export const REAL = {
  ...
  networkInternal: [
    "simulation-arm-server-1",
    "simulation-postgres-ent-1",
    "simulation-clickhouse-ent-1",
  ],
  ...
  containers: [
    {
      name: "simulation-arm-server-1",
      status: "Up 2 hours",
      ports: "0.0.0.0:8787->8787/tcp",
    },
    {
      name: "simulation-postgres-ent-1",
      status: "Up 2 hours (healthy)",
      ports: "5432/tcp",
    },
    {
      name: "simulation-clickhouse-ent-1",
      status: "Up 2 hours (healthy)",
  ...
  sarahTerminal: [
    ...
    {
      text: "Department: Engineering · Agent: Claude Code",
      dir: "ok" as const,
    },
    ...
    {
      text: "DNS resolved — arm.armtest.com → internal IP",
      dir: "ok" as const,
    },
    {
      text: "ARM Proxy v2.0.0-simulation — 6 features active",
      dir: "ok" as const,
    },
    {
      text: "DLP scanner · Classification gate · Budget enforcement",
      dir: "ok" as const,
    },
    { text: "", dir: "ok" as const },
    {
      text: "Sarah Chen's Claude Code agent is now active",
      dir: "ok" as const,
    },
    { text: "", dir: "ok" as const },
    { text: "[Engineering] Sending prompt to minicpm5-1b", dir: "in" as const },
    {
      text: "98 tokens in 5776ms · cloud $0.0100 · saved $0.0100",
      dir: "ok" as const,
    },
    { text: "[Engineering] Sending prompt to minicpm5-1b", dir: "in" as const },
    {
      text: "105 tokens in 18099ms · cloud $0.0100 · saved $0.0100",
      dir: "ok" as const,
    },
    { text: "[Engineering] Sending prompt to minicpm5-1b", dir: "in" as const },
    {
      text: "98 tokens in 35366ms · cloud $0.0100 · saved $0.0100",
      dir: "ok" as const,
    },
    { text: "[Engineering] Sending prompt to minicpm5-1b", dir: "in" as const },
    {
      text: "87 tokens in 1332ms · cloud $0.0100 · saved $0.0100",
      dir: "ok" as const,
    },
    { text: "[Engineering] Sending prompt to minicpm5-1b", dir: "in" as const },
    {
      text: "105 tokens in 19839ms · cloud $0.0100 · saved $0.0100",
      dir: "ok" as const,
    },
    { text: "[Engineering] Sending prompt to minicpm5-1b", dir: "in" as const },
    {
      text: "87 tokens in 118777ms · cloud $0.0100 · saved $0.0100",
      dir: "ok" as const,
    },
    { text: "", dir: "ok" as const },
    {
      text: "Session complete — 6 calls processed through ARM governance",
      dir: "ok" as const,
    },
  ],
  ...
  jennyTerminal: [
    {
      text: "Authenticating with ARM via Claude Code plugin...",
      dir: "ok" as const,
    },
    {
      text: "DLP scanner active · Classification gate active · Budget enforcement active",
      dir: "ok" as const,
    },
    {
      text: "Jenny Park (QA Lead)'s Claude Code agent is now active",
      dir: "ok" as const,
    },
    { text: "", dir: "ok" as const },
    {
      text: "[Quality Assurance] Sending prompt to qwen3.5",
      dir: "in" as const,
    },
    {
      text: "BLOCKED by policy: DLP gate blocked: API Key (sk-ant-) detected in prompt",
      dir: "block" as const,
    },
    {
      text: "[Quality Assurance] Sending prompt to qwen3.5",
    ...
    {
      text: "96 tokens in 57881ms · cloud $0.0100 · saved $0.0100",
      dir: "ok" as const,
    },
    {
      text: "[Quality Assurance] Sending prompt to qwen3.5",
    ...
    { text: "", dir: "ok" as const },
    {
      text: "Session complete — 3 calls processed (2 DLP blocks)",
      dir: "ok" as const,
    },
  ],
  ...
  workTypeEvents: [
    ...
    {
      dept: "Manufacturing",
      prompt: '"optimize CNC toolpath g-code..."',
    ...
    {
      dept: "Supply Chain",
      prompt: '"forecast demand for inventory..."',
    ...
    {
      dept: "Quality Assurance",
      prompt: '"write a test with coverage..."',
      workType: "test_generation",
      stage: "linear",
      conf: 1.0,
      tokens: 34,
    },
    {
      dept: "Manufacturing",
      prompt: '"analyze SPC defect data..."',
      workType: "defect_analysis",
      stage: "linear",
      conf: 1.0,
      tokens: 35,
    },
    {
      dept: "Research & Development",
      prompt: '"summarize research literature..."',
      workType: "research_synthesis",
      stage: "linear",
      conf: 1.0,
      tokens: 33,
    },
  ...
  classifierCascade: [
    {
      stage: "1",
      name: "Structural",
      mechanism: "model_id · agent type · tool calls · file extensions",
      cost: "$0",
      latency: "0ms",
      coverage: "~60%",
    },
    {
      stage: "2",
      name: "Hash Cache",
      mechanism: "prompt-hash → label LRU (10K entries)",
      cost: "$0",
      latency: "ns",
      coverage: "repeats",
    },
    {
      stage: "3",
      name: "Linear",
      mechanism: "keyword classifier per taxonomy",
      cost: "$0",
      latency: "µs",
    ...
    },
    {
      stage: "4",
      name: "Embedding",
      mechanism: "centroid similarity (only on ambiguous tail)",
      cost: "$0",
      latency: "6-35ms",
      coverage: "low-conf fallback",
    },
    {
      stage: "QA",
      name: "LLM Judge",
      mechanism: "sampled 1-5% · batch cron · NOT in hot path",
      cost: "1-5%",
      latency: "offline",
      coverage: "drift audit",
    },
  ],
};
