        ...
        <div style={{ flex: 1.6, display: "flex", flexDirection: "column" }}>
          <div style={{
            ...
            <Img
              ...
              style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "50% 78%", display: "block" }}
            />
          </div>
          <div style={{
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 12, justifyContent: "center", minWidth: 0 }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 12, fontFamily: FONT_MONO, color: COLORS.text }}>
              {V6.chat.classification.tag} → <span style={{ fontWeight: 700 }}>{V6.chat.classification.jobFunctionHint}</span>
            </div>
          </div>
          ...
          <div style={{
            ...
            Never a third party, never ARM's own control plane — the same armProxyUrl +
            agentToken every other tool call this install makes already uses.
          </div>
        </div>
      </div>
    </div>
