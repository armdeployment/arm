        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 10, justifyContent: "center", minWidth: 0 }}>
          {[
            ...
            <div key={kv.label} style={{
              ...
              <span style={{ fontSize: 13, color: COLORS.textMuted }}>{kv.label}</span>
              <span style={{ fontSize: 18, fontWeight: 800, color: COLORS.navy, fontFamily: FONT_MONO }}>{kv.value}</span>
            </div>
          ))}
          <div style={{
            ...
            <div style={{ fontSize: 12, fontWeight: 700, color: COLORS.white, marginBottom: 8 }}>
              {V6.install.components.length} real components
            </div>
            <div style={{ fontSize: 10.5, color: COLORS.textDarkMuted, fontFamily: FONT_MONO, lineHeight: 1.8 }}>
