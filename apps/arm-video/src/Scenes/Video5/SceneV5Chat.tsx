      ...
      <div style={{ display: "flex", gap: 18, width: "100%", flex: 1, minHeight: 0 }}>
        <div style={{ flex: 1.6, display: "flex", flexDirection: "column" }}>
          <div style={{
            ...
            <Img
              ...
              style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "50% 65%", display: "block" }}
            />
          </div>
          <div style={{
            ...
            Real screenshot — a live reply from Ollama, routed through the real proxy
          </div>
        </div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 12, justifyContent: "center", minWidth: 0 }}>
          <div style={{
            ...
            <div style={{ fontSize: 12.5, color: COLORS.white, fontStyle: "italic", lineHeight: 1.6 }}>
          ...
          <div style={{
            ...
            backgroundColor: "rgba(22,163,74,0.06)", border: `1px solid ${COLORS.green}33`,
            ...
            <div style={{ fontSize: 12, fontFamily: FONT_MONO, color: COLORS.text }}>
              {V5.classification.tag} → <span style={{ fontWeight: 700 }}>{V5.classification.jobFunctionHint}</span>
            </div>
          </div>
          ...
          <div style={{
            ...
            Same deterministic classifyPainPoints() a plain textarea used — the transcript
            isn't the audited signal, the extracted tag is.
          </div>
        </div>
      </div>
    </div>
