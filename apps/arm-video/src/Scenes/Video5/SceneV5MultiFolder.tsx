      ...
      <div style={{ display: "flex", gap: 18, width: "100%", flex: 1, minHeight: 0 }}>
        <div style={{ flex: 1.6, display: "flex", flexDirection: "column" }}>
          ...
          <div style={{
            ...
            Real screenshot — two real folders, real tags, real installed-tool detection
          </div>
        </div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 10, justifyContent: "center", minWidth: 0 }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
              {V5.folders.tags.map((tag) => (
                <span key={tag} style={{
                  fontSize: 10.5, fontFamily: FONT_MONO, color: COLORS.goldLight,
                  border: `1px solid ${COLORS.goldLight}55`, borderRadius: 5, padding: "3px 7px",
                }}>
                  {tag}
                </span>
              ))}
          ...
          <div style={{
            ...
            One unreadable folder never blocks the others — extensions only, never file
            names or contents, all local (A5).
          </div>
        </div>
      </div>
    </div>
