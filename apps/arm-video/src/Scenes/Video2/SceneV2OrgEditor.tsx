      ...
      <div style={{ display: "flex", gap: 18, width: "100%", flex: 1, minHeight: 0 }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 12, justifyContent: "center", minWidth: 0 }}>
          {EDIT_STEPS.map((step, i) => {
            ...
            return (
              <div key={i} style={{
                ...
                <div>
                  <div style={{ fontSize: 17, fontWeight: 700, color: COLORS.text }}>{step.label}</div>
                  <div style={{ fontSize: 13, color: COLORS.textMuted, fontFamily: FONT_MONO, marginTop: 2 }}>{step.detail}</div>
                </div>
                {isDanger && (
                  <span style={{
          ...
          <div style={{
            ...
            backgroundColor: COLORS.navy, borderRadius: 10, padding: "14px 18px",
          }}>
            <div style={{ fontSize: 14, fontWeight: 700, color: COLORS.white }}>🔐 Every edit is permission-checked (D8)</div>
            <div style={{ fontSize: 12, color: COLORS.textDarkMuted, marginTop: 4, fontFamily: FONT_MONO }}>
