      ...
      <div style={{ display: "flex", gap: 18, width: "100%", flex: 1, minHeight: 0 }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 12, justifyContent: "center", minWidth: 0 }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 15, fontWeight: 700, color: COLORS.text, marginBottom: 10 }}>Authority Flow</div>
            <div style={{ fontSize: 14, lineHeight: 1.9, color: COLORS.textMuted }}>
              <div>🏛️ <strong>Org Admin</strong> → all verbs, all scopes</div>
              <div style={{ paddingLeft: 22, color: COLORS.textMuted }}>↓ delegates create + rename</div>
          ...
          <div style={{
            ...
            backgroundColor: COLORS.navyDark, borderRadius: 10, padding: "16px 20px",
          }}>
            <div style={{ fontSize: 15, fontWeight: 700, color: COLORS.white, marginBottom: 8 }}>⚙ Governing rules</div>
            {V2.governingRules.map((rule, i) => (
              <div key={i} style={{ fontSize: 12, color: COLORS.textDarkMuted, marginTop: 5, fontFamily: FONT_MONO, lineHeight: 1.6 }}>
