  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          A manufacturing company has HQ + plants in different locations. A
          holding company has subsidiaries with their own orgs. A fintech has
          Chinese walls. ARM provisions each structure in minutes — then lets
          your org_admin reshape it as you grow.
        </div>
      </div>
