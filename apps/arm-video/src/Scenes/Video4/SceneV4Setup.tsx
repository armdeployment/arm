...
export const SceneV4Setup: React.FC = () => {
  ...
  const commandTyped = Math.min(V4.setupCommand.length, Math.max(0, Math.floor((frame - 6) * 2.2)));
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <Monitor name="Terminal" title="arm setup" subtitle="~/senior-manager-agent" width={1000} height={640} bezel="#1E293B" screenBg="#0F172A" rounded={10}>
          <div style={{ padding: "16px 20px", fontFamily: FONT_MONO, fontSize: 14.5, color: COLORS.greenDark }}>
