    ...
    >
      ...
      >
        ...
        >
            ...
            {V4.scoring.map((row, i) => (
              ...
              >
                ...
                <span
                  style={{
                    color:
                      row.weight > 0 ? COLORS.goldLight : COLORS.textDarkMuted,
                    fontWeight: 700,
                  }}
                >
          ...
          >
            @arm/questionnaire's score() is pure and deterministic — no LLM, no
            I/O. Same answers always rank the same job function (A5).
          </div>
        </div>
      </div>
    </div>
