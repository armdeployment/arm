  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          A company buys agents the way it buys laptops — but has none of the
          machinery it has for laptops. Who has one? What can it touch? What did
          it cost? Did anyone actually use it? ARM is that missing layer, and it
      ...
      >
        {PLANES.map((p, i) => (
          <div
            key={p.name}
            style={{
              opacity: interpolate(frame, [24 + i * 12, 40 + i * 12], [0, 1], {
                extrapolateLeft: "clamp",
                extrapolateRight: "clamp",
              }),
          ...
          >
            ...
            <div
              style={{
                fontSize: 15.5,
                color: p.color === COLORS.navy ? "#93B4E8" : COLORS.goldLight,
                marginTop: 5,
                fontWeight: 600,
              }}
            >
      ...
      >
        Prompt bodies never cross into the control plane — Invariant 1, enforced
