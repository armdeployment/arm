...
const PANELS = [
  {
    label: "Act 1 · The Employee",
    sub: "install, no terminal",
    image: "install-e2e/05-gui-installed.png",
    accent: COLORS.cyan,
  },
  {
    label: "Act 2 · The Manager",
    sub: "adoption and spend",
    image: "full-demo/mgr-02-adoption.png",
    accent: COLORS.goldLight,
  },
  {
    label: "Act 3 · The Server",
    sub: "the component library",
...
export const DemoPoster: React.FC = () => (
  ...
  >
    <div style={{ textAlign: "center" }}>
      ...
      >
        An employee installing an agent, a manager governing adoption and spend,
        and the server-side library behind both — every screen a real capture
        from a live run.
      </div>
    </div>
    ...
    <div
      style={{ display: "flex", alignItems: "center", gap: 18, marginTop: 48 }}
    >
      <div
        style={{
          width: 74,
      ...
      <div>
        <div style={{ fontSize: 25, fontWeight: 700, color: COLORS.white }}>
          Watch the full demo · 1:47
        </div>
        <div
          style={{
            fontSize: 17,
