  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          When your engineers, manufacturing leads, and QA teams work with
          coding agents, ARM classifies every prompt by work-type — in
          microseconds, without spending a single token on classification.
        </div>
      </div>
      ...
      >
        {V1.employees.map((emp, i) => {
          const appear = interpolate(frame, [25 + i * 5, 38 + i * 5], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
          });
          return (
            ...
            >
              ...
              <div style={{ fontSize: 10, color: COLORS.textDarkMuted }}>
                {emp.dept}
              </div>
            </div>
          );
