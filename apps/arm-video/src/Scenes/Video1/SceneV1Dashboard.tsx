        ...
        >
          ...
          >
            ...
            <div
              style={{
                display: "grid",
                gridTemplateColumns: "1.2fr 1fr 1.4fr 0.7fr 0.7fr",
                padding: "8px 14px",
                fontSize: 11,
                fontWeight: 700,
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    alignItems: "center",
                    borderBottom:
                      i < V1.classification.length - 1
                        ? `1px solid ${COLORS.slate800}`
                        : "none",
                  }}
                >
                  <div style={{ color: COLORS.white }}>{row.agent}</div>
                  <div style={{ color: row.color }}>{row.dept}</div>
                  <div style={{ color: COLORS.greenDark, fontWeight: 700 }}>
                    {row.workType}
                  </div>
                  <div style={{ color: COLORS.textDarkMuted }}>{row.stage}</div>
                  <div style={{ color: COLORS.textDarkMuted }}>
                    {row.conf.toFixed(1)}
                  </div>
                </div>
              );
          ...
          >
            ...
            {V1.dlpBlocks.map((block, i) => (
              ...
              >
                {block.agent} —{" "}
                <span style={{ color: COLORS.red }}>{block.reason}</span>{" "}
