  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ fontWeight: 700, marginBottom: 4, color: COLORS.navy }}>
            Incoming prompt
          </div>
          <div
            style={{
      ...
      >
        ...
        >
          {V1.proxyClassificationLog.map((line, i) => {
            ...
            const emp =
              V1.employees.find((e) => e.dept === deptMatch?.[1]) ??
              V1.employees[0]!;
            return (
              <div
                key={i}
      ...
      >
        {V1.cascade.map((stage, i) => {
          const appear = interpolate(frame, [55 + i * 6, 65 + i * 6], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
          });
          return (
