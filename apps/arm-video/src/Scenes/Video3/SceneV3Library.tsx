    ...
    >
      ...
      >
        <div style={{ flex: 1.6, display: "flex", flexDirection: "column" }}>
          ...
          >
            ARM dashboard · /library → Discovery — "Promote" writes a real
            component row (real screenshot)
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            >
              {V3.library.firstParty} first_party · {V3.library.tenantAuthored}{" "}
              tenant_authored
            </div>
          </div>
          ...
          >
            ...
            <div
              style={{ fontSize: 10.5, color: COLORS.textMuted, marginTop: 8 }}
            >
          ...
          >
            ...
            >
              the real ComponentRepoPort implementation — publishVersion picks
              it (vs the in-memory stand-in) by the same isFixtureMode() gate
