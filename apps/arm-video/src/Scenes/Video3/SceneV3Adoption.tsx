...
export const SceneV3Adoption: React.FC = () => {
  ...
  const kpis = [
    {
      label: "Weekly Active",
      value: V3.adoption.weeklyActive,
      color: COLORS.green,
    },
    {
      label: "Activated Seats",
      value: V3.adoption.activatedSeats,
      color: COLORS.navy,
    },
    {
      label: "Eligible Seats",
      value: V3.adoption.eligibleSeats,
      color: COLORS.cyan,
    },
  ];
    ...
    >
      ...
      >
        <div style={{ flex: 1.6, display: "flex", flexDirection: "column" }}>
          ...
          >
            ARM dashboard · /adoption — ARM_FIXTURE_MODE=0 (real screenshot,
            real numbers)
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            >
              {V3.adoption.topStall.cause} —{" "}
              <span style={{ color: COLORS.red, fontWeight: 700 }}>
                {V3.adoption.topStall.count}
              </span>{" "}
              cases
            </div>
          </div>
          ...
          >
            Every number above comes from buildCoverageSQL /
            buildActivatedSeatsSQL / buildWeeklyActiveTrendSQL running against
            real activation_event rows — not the ClickHouse mock this router
            shipped with.
          </div>
        </div>
      </div>
