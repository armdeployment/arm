  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            {REAL.containers.map((c, i) => {
              const o = interpolate(frame, [8 + i * 4, 14 + i * 4], [0, 1], {
                extrapolateLeft: "clamp",
                extrapolateRight: "clamp",
              });
              const isHealthy =
                c.status.includes("healthy") || c.status.includes("Up");
              ...
              return (
                ...
                >
                  ...
                  >
                    {isExited
                      ? "✓ done"
                      : "● " + c.status.replace("Up 2 hours", "running")}
                  </span>
                </div>
              );
            })}
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                10 agents · 5 depts · 4 models · all active
              </span>
            </div>
          </div>
        </Monitor>
        ...
        <Monitor
          name="ClickHouse"
          title="📊 CLICKHOUSE METERING"
          subtitle="SELECT FROM llm_events"
          width={400}
          height={560}
          bezel="#1E293B"
          screenBg="#0F172A"
        >
          ...
          >
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      textAlign: "right",
                      fontSize: 12,
                      color: isDenied ? COLORS.red : COLORS.green,
                      fontWeight: 700,
                    }}
                  >
                    {m.calls}
            ...
            >
              ...
              >
                <span style={{ fontSize: 11, color: COLORS.textDarkMuted }}>
                  Total tokens
                </span>
                <span
                  style={{ fontSize: 13, color: COLORS.cyan, fontWeight: 700 }}
                >
                  {REAL.totals.totalTokens.toLocaleString()}
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                <span
                  style={{ fontSize: 13, color: COLORS.green, fontWeight: 700 }}
                >
                  ${(REAL.totals.cloudCostCents / 100).toFixed(2)}
                </span>
              </div>
            </div>
          </div>
        ...
        <Monitor
          name="Policy"
          title="🔒 POLICY EVENTS"
          subtitle="SELECT FROM policy_events"
          width={340}
          height={560}
          bezel="#1E293B"
          screenBg="#0F172A"
