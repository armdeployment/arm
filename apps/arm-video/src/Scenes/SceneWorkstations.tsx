...
export const SceneWorkstations: React.FC = () => {
  ...
  const renderApp = (app: string) => {
    switch (app) {
      case "vscode":
        return <VSCOdeEditor frame={frame} />;
      case "terminal":
        return <Terminal frame={frame} />;
      case "dashboard":
        return <ProductionDashboard frame={frame} />;
      case "qa":
        return <QATestRunner frame={frame} />;
      case "supply":
        return <SupplyChainView frame={frame} />;
      case "vpn":
        return <VPNStatusView frame={frame} />;
      default:
        return null;
    }
  };
  ...
  return (
    ...
    >
      ...
      {EMPLOYEES.map((emp, i) => {
        ...
        const yOff = interpolate(frame, [delay, delay + 10], [24, 0], {
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp",
          easing: Easing.bezier(0.16, 1, 0.3, 1),
        });
