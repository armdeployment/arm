  ...
  return (
    ...
    >
      ...
      <div style={{ position: "absolute", left: 60, top: 100 }}>
        <Monitor
          name="Jenny Terminal"
          title="💻 emp-jenny-1 · Quality Assurance"
          subtitle="Claude Code · real docker logs"
          width={840}
          height={620}
          bezel="#1E293B"
          screenBg="#0F172A"
        >
          ...
          >
            {REAL.jennyTerminal.map((line, i) => {
              const o = interpolate(frame, [i * 6, i * 6 + 8], [0, 1], {
                extrapolateLeft: "clamp",
                extrapolateRight: "clamp",
              });
              if (o <= 0) return null;
      ...
      <div style={{ position: "absolute", right: 60, top: 100 }}>
        <Monitor
          name="Policy Query"
          title="🔒 CLICKHOUSE POLICY EVENTS"
          subtitle="real query result"
          width={840}
          height={620}
          bezel="#172554"
          screenBg="#0F172A"
          glow={frame > 30 ? "rgba(220,38,38,0.2)" : undefined}
        >
          <div
            style={{
              padding: 28,
          ...
          >
            ...
            >
              clickhouse-client --query "SELECT decision, reason, count()
              <br />
              FROM arm.policy_events GROUP BY decision, reason"
            </div>
            <div
              style={{
                ...
                return (
                  <div key={i} style={{ opacity: o, marginBottom: 24 }}>
                    ...
                    >
                      ...
                      <span
                        style={{ fontSize: 16, color: COLORS.textDarkMuted }}
                      >
                        events
                      </span>
                    </div>
            ...
            >
              ...
              <div style={{ display: "flex", gap: 32 }}>
                <div>
                  <div
                    style={{ fontSize: 28, fontWeight: 800, color: COLORS.red }}
                  >
                    3
                  </div>
