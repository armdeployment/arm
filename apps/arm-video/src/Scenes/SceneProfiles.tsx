  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Profiles set defaults at provisioning time — they never gate
          capabilities. A manufacturing company gets HQ + multiple plants; a
          holding company gets subsidiaries with their own orgs.
        </div>
      </div>
      ...
      <div style={{ display: "flex", gap: 18, marginTop: 6 }}>
        {profiles.map((p, i) => {
          const appear = interpolate(frame, [10 + i * 8, 25 + i * 8], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
          });
          const y = interpolate(frame, [10 + i * 8, 25 + i * 8], [40, 0], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
            easing: Easing.bezier(0.16, 1, 0.3, 1),
          });
                    ...
                    return (
                      ...
                      >
                        ...
                        <span
                          style={{
                            fontSize: 12,
                            fontWeight: isPlant || isHq || isOrg ? 600 : 400,
                            color: nodeColor,
                            flex: 1,
                          }}
                        >
      ...
      >
        ...
        <span style={{ fontSize: 13, color: COLORS.white, fontWeight: 500 }}>
          <code style={{ fontFamily: FONT_MONO, color: COLORS.goldLight }}>
            no-profile-branching
          </code>{" "}
          guardrail enforced — runtime code never reads the profile id
        </span>
      </div>
    </div>
  );
