...
export const V5 = {
  chatExchange: {
    ...
    assistant:
      "Understood. This is a common operational bottleneck at manufacturing plants where budget approvals are consistently delayed...",
    model: "minicpm5-1b",
  },
  ...
  routing: [
    ...
    {
      label: "Tenant's own proxy",
      detail: "armProxyUrl + agentToken — same as any tool call",
    },
  ...
  notRouting: [
    {
      label: "Third-party API directly",
      reason: "ungoverned egress, never approved",
    },
    {
      label: "ARM's control plane",
      reason: "metadata + audit only — Invariant 1",
    },
  ],
  ...
  folders: {
    ...
    projectB: {
      name: "cad-project",
      files: ["part1.sldprt", "part2.sldprt", "part3.sldprt", "part4.sldprt"],
    },
    totalFiles: 11,
