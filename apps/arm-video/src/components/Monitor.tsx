...
export const Monitor: React.FC<{
  ...
  const appear = interpolate(frame, [-20, 15], [0, 1], {
  ...
  return (
    <Interactive.Div
      ...
      style={{
        ...
        padding: 14,
        boxShadow: glow
          ? `0 0 50px ${glow}, 0 20px 60px rgba(0,0,0,0.4)`
              ...
              {title && (
                <span
                  style={{
                    fontSize: 13,
                    fontWeight: 700,
                    color: bezel === "#1E293B" ? COLORS.text : COLORS.textDark,
...
export const Terminal: React.FC<{
  ...
  return (
    ...
    >
      {lines.map((line, i) => {
        const delay = i * 8;
        const o = interpolate(frame, [delay, delay + 6], [0, 1], {
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp",
        });
        if (o <= 0) return null;
        ...
        return (
          ...
          >
            ...
            <span style={{ color: line.color || COLORS.textDark }}>
              {line.text}
            </span>
          </div>
        );
      ...
      {active && (
        <div
          style={{
            opacity: interpolate(frame, [0, fps * 0.5, fps], [1, 1, 0], {
              extrapolateLeft: "clamp",
        ...
        >
          <span
            style={{ color: COLORS.green, fontFamily: FONT_MONO, fontSize }}
          >
            ▋
          </span>
        </div>
