...
export const HOLDING_JOB_FUNCTIONS: JobFunctionSeed[] = [
  { key: "consolidation_analyst", name: "Consolidation Analyst", functionFamily: "Corporate Finance", aliases: ["consolidation analyst"], headcountWeight: 10 },
  { key: "portfolio_manager", name: "Portfolio Manager", functionFamily: "Corporate Finance", aliases: ["portfolio manager"], headcountWeight: 4 },
