...
const PACKAGE_VERSION_SEEDS: PackageVersionSeedSpec[] = [
  {
    ...
    seed: {
      ...
      components: [
        {
          ...
          kind: "mcp",
          scopes: ["read:issue", "write:comment", "transition:issue"],
        },
        {
          component: "historian-pi",
          componentVersion: "1.0.0",
          kind: "connector",
          scopes: ["read:tags", "read:archive"],
        },
        ...
        {
          component: "8d-root-cause-solver",
          componentVersion: "1.0.0",
          kind: "subagent",
          scopes: [],
        },
      ...
      starterPrompts: [
        "Draft an 8D for defect D-1042",
        "Generate a PPAP checklist for part 4477-B",
      ],
  ...
  },
  {
    ...
    seed: {
      ...
      components: [
        ...
        {
          component: "diff-merge-reviewer",
          componentVersion: "1.0.0",
          kind: "subagent",
          scopes: [],
        },
        {
          component: "tpl_ladder_patterns",
          componentVersion: "1.0.0",
          kind: "template",
          scopes: [],
        },
        {
          component: "tpl_alarm_templates",
          componentVersion: "1.0.0",
          kind: "template",
          scopes: [],
        },
      ...
      starterPrompts: [
        "Generate ladder logic for a 3-motor sequence",
        "Diff my AOI against the library baseline",
      ],
      minAgentVersion: "1.4.0",
    },
  },
  {
    ...
    seed: {
      ...
      components: [
        {
          ...
          componentVersion: "1.0.0",
          kind: "connector",
          scopes: ["workorder:read", "workorder:update", "asset:read"],
        },
        {
          component: "historian-pi",
          componentVersion: "1.0.0",
      ...
      starterPrompts: [
        "Fault FC-1042 on Line A — walk me through the fix",
        "Write the closing notes for WO-8821",
      ],
      minAgentVersion: "1.4.0",
    },
  },
  {
    ...
    seed: {
      ...
      components: [
        ...
        {
          component: "meeting-notes-actions",
          componentVersion: "1.0.0",
          kind: "skill",
          scopes: [],
        },
      ...
      starterPrompts: [
        ...
        "Turn these meeting notes into Jira tasks",
      ],
      minAgentVersion: "1.4.0",
    },
  },
  {
    ...
    seed: {
      ...
      components: [
        ...
        {
          component: "kpi-briefing-generator",
          componentVersion: "1.0.0",
          kind: "skill",
          scopes: [],
        },
      ...
      starterPrompts: [
        "Brief me on yesterday's OEE across plants",
        "Summarize the approvals inbox",
      ],
      minAgentVersion: "1.4.0",
    },
  },
      ...
      components: [
        {
          ...
          componentVersion: "1.0.0",
          kind: "connector",
          scopes: ["inventory:read", "workorder:read"],
        },
        {
          component: "historian-pi",
          componentVersion: "1.0.0",
        ...
        {
          component: "exception-triage-batch",
          componentVersion: "1.0.0",
          kind: "subagent",
          scopes: [],
        },
        {
          component: "tpl_exception_card",
          componentVersion: "1.0.0",
          kind: "template",
          scopes: [],
        },
  ...
  },
  {
    ...
    seed: {
      ...
      starterPrompts: [
        "Show my team's ARM adoption funnel",
        "What's waiting in my approvals inbox?",
      ],
      minAgentVersion: "1.4.0",
    },
  },
