...
```bash
cd apps/arm-video
npx remotion render ArmVideo7-FullSystem ../../demo/arm-full-demo.mp4
```

The poster is a one-frame composition rendered from the same sources:

```bash
cd apps/arm-video
npx remotion still ArmVideo7-Poster ../../demo/arm-full-demo-poster.png
```
